...
void Unit::SetImage(const std::string& imageFile)
{
	mImage.LoadImage(imageFile);
}
...
void Unit::Draw(Protocol::Shader& shader)
{
	Protocol::Renderer::Draw(mImage, mPosX, mPosY, mImage.GetWidth(), mImage.GetHeight(), shader);
}
